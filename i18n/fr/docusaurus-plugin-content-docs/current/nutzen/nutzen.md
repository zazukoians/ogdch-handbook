...
[Datensuche](daten-suchen.md) und zur
[Nutzung unserer API](api-nutzen.md) anbieten. Bitte beachten Sie,
...
[Geschäftsstelle OGD](../glossar/begriffe.md#term-Geschaftsstelle-Open-Government-Data-OGD) uns
über [Ihre Anfrage](mailto:opendata@bfs.admin.ch).
...
[Nehmen Sie Kontakt auf](mailto:info@opendata.ch).

- [Daten suchen](daten-suchen.md)
- [API nutzen](api-nutzen.md)

Mehr zum Thema

- [Nutzungsbedingungen (Link)](https://opendata.swiss/de/terms-of-use/),
