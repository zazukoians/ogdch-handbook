...
- [Ich möchte ein Problem melden](#support-problem-melden)
- [Ich habe einen Vorschlag, wie man das Portal opendata.swiss verbessern könnte](#support-feedback)
- [Ich benötige Unterstützung bei der Veröffentlichung oder Anpassung meiner Einträge auf opendata.swiss](#support-beratung)

<a id="support-problem-melden"></a>
...
- Melden Sie das Problem bitte an die Geschäftsstelle OGD
  [Geschäftsstelle OGD](mailto:opendata@bfs.admin.ch).
...
Am besten reichen Sie [uns](mailto:opendata@bfs.admin.ch)
