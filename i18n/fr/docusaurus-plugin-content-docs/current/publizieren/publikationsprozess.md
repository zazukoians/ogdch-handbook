...
von [«Abnahmeumgebung»](../glossar/begriffe.md#term-Abnahmeumgebung). Erst nach der finalen
Freigabe werden die Datasets öffentlich auf opendata.swiss publiziert,
auf der sogenannten [«Produktionsumgebung»](../glossar/begriffe.md#term-Produktionsumgebung).
...
[Publikationsvarianten](publikationsvariante.md),
die Ihnen zur Verfügung stehen:

- [Dataset manuell via Webformular erfassen](publikationsvarianten/metadaten-manuell-erfassen.md)
- [Datenkatalog als XML importieren](publikationsvarianten/metadaten-via-xml-hochladen.md)
- [Datenkatalog via Harvester erfassen](publikationsvarianten/harvesting.md)
- [Geodaten via geocat.ch erfassen](publikationsvarianten/geodaten.md) (Wichtig: Alle Geodaten müssen nach dieser Methode publiziert werden)
...
dazu finden Sie im
Kapitel [Publikationsvariante auswählen](publikationsvariante.md).
...
selbstverständlich jederzeit [kontaktieren](mailto:opendata@bfs.admin.ch).
