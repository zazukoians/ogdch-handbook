...
: [Metadaten manuell via Webformular erfassen](publikationsvarianten/metadaten-manuell-erfassen.md)

Mehr als 10 Datasets, regelmässige Aktualisierung:
: [Metadaten als XML-Datei importieren](publikationsvarianten/metadaten-via-xml-hochladen.md)

Grosse Anzahl Datasets, häufige Aktualisierung:
: [Metadaten mit Harvester automatisch hochladen](publikationsvarianten/harvesting.md)
