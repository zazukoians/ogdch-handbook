...
![Harvester Suche im Backend von opendata.swiss](/images/publizieren/harvesting/harvester-suche.png)

Wenn Sie Ihren Harvester gefunden haben: klicken Sie auf den Link, dann gelangen Sie zur Detailansicht
des Harvesters:

![Harvester verwalten](/images/publizieren/harvesting/harvester-ansicht.png)
...
![Dashboard für das Management eines Harvesters](/images/publizieren/harvesting/harvest-admin-dashboard.png)
...
![Übersicht Harvester-Jobs](/images/publizieren/harvesting/harvest-jobs.png)
...
![Harvester-Konfiguration im Webformular](/images/publizieren/harvesting/harvester-aktualisieren.png)
...
![Datasets eines Harvesters](/images/publizieren/harvesting/harvester-datasets.png)
...
![CKAN URL einer Organisation](/images/publizieren/organisation/ckan-organisations-url.png)![Frontend URL einer Organisation](/images/publizieren/organisation/frontend-organisations-url.png)![Organisation im Frontend von opendata.swiss](/images/publizieren/harvesting-frontend-check.png)

Beispielansicht einer publizierten Organisation

![Dataset im Frontend von opendata.swiss](/images/publizieren/harvesting-dataset-frontend-check.png)
...
- [`Harvester konfigurieren`](../../..//screencasts/configure-harvester.gif) - In diesem Screencast zeigen wir Ihnen, wie Sie Ihren Harvester konfigurieren können
- [`Harvester starten`](../../..//screencasts/run-harvester.gif) - In diesem Screencast zeigen wir Ihnen, wie Sie Ihren Harvester starten können
