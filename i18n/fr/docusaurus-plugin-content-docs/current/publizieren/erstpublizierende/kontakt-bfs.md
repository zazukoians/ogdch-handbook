...
und Ihres Profils mit uns [Kontakt](mailto:opendata@bfs.admin.ch)
auf.
...
- [Erste Aktivierung von Organisation und Benutzerinnen und Benutzer](#erste-aktivierung)
- [Zugang anfordern](#zugang-anfordern)

<a id="erste-aktivierung"></a>
...
- Alle Benutzerinnen und Benutzer erhalten dann die Möglichkeit,
  über das [Backend](../../glossar/begriffe.md#term-Backend) von opendata.swiss Daten
...
um Ihre Anfrage zu bearbeiten. [Jetzt Zugang anfordern](mailto:opendata@bfs.admin.ch).
...
[Nächster Schritt: Profil verwalten](profil-einrichten.md)
