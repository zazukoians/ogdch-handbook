...
![Suchfeld auf der Seite Daten auf opendata.swiss](_static/images/daten-suchen/suchfeld-opendataswiss.png)![Suche auf opendata.swiss](_static/images/daten-suchen/Trefferliste_de.png)
...
![Filterfacetten](_static/images/daten-suchen/bild-facetten.png)
...
![sortieren nach](_static/images/daten-suchen/sortieren-nach.png)
...
![Suche auf opendata.swiss](_static/images/daten-suchen/suchvorschlaege.png)
...
![Suche nach Begriffen open und data ohne Operatoren](_static/images/daten-suchen/suche_open-data.png)
...
![Suche nach Begriffen open und data mit dem OR-Operator](_static/images/daten-suchen/suchmodi_OR.png)
...
![Suche nach Begriffen open und data mit dem AND-Operator](_static/images/daten-suchen/suchmodi_and.png)
...
![Suche nach Begriffen mit Plus-Zeichen vor open und Minus-Zeichen vor data](_static/images/daten-suchen/Suchmodus_plusundminus.png)
...
![Suche nach dem Begriff open data mit Anführungszeichen](_static/images/daten-suchen/phrasensuche.png)
...
![Suche in description nach Phrase open data](_static/images/daten-suchen/suche-in-description_1.png)
...
![Suche in description mit AND-Operator](_static/images/daten-suchen/suche-in-description_2.png)![Suche in description mit OR-Operator](_static/images/daten-suchen/suche-in-description_3.png)
...
![+title_en:power](_static/images/daten-suchen/suche-in-title_einschliessen.png)
...
![+title_en:power -title_en:hydraulic](_static/images/daten-suchen/suche-in-title_auschliessen.png)
...
![keywords_en:(geology AND geophysics)](_static/images/daten-suchen/keywords-suche.png)
...
![URL der Organisation Kanton Thurgau](_static/images/daten-suchen/slug-organisation.png)![organization:(kanton-thurgau OR stadt-zurich)](_static/images/daten-suchen/suche-organisation.png)

Diese Suche kann auch noch erweitert werden. In unserem Beispiel mit dem Suchbegriff `karte`.

![organization:(kanton-thurgau OR stadt-zurich)karte](_static/images/daten-suchen/suche-in-organisation-begriff.png)
...
![title_de:(bild AND farbe)](_static/images/daten-suchen/suche-wortstamm.png)
