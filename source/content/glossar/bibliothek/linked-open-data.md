...
data economy <sup>[1](#id60)</sup>. At greater quantities, we are
...
[dataformats](formate-ressourcen.md)), or to provide access to
this data through programming interfaces ([APIs](../../nutzen/api-nutzen.md)).
...
a global information space <sup>[2](#id61)</sup> . Linked Data
...
[design principles of Linked Data](https://www.w3.org/DesignIssues/LinkedData.html),
...
![5 stars of Open Data](_static/images/linked-open-data/ld-5stars.png)
...
As an example, the
[final report of the W3C sample applications of Linked Data in library environment](https://www.w3.org/2005/Incubator/lld/wiki/Benefits)
...
based on the W3C [Best Practices for Publishing Linked Data](https://www.w3.org/TR/ld-bp)
...
[Terms of use](https://opendata.swiss/en/terms-of-use) for
OpenData.swiss.
...
> ![URL-URI-IRI](_static/images/linked-open-data/ld-iri-uri.png)
...
the original [URI Construction](https://www.w3.org/TR/ld-bp/#HTTP-URIS)
section which
cites references to different documents. We would like to point out that
the [Study on persistent URIs](http://philarcher.org/diary/2013/uripersistence/)
is a nice Web
representation of the very complete
[10 Rules for Persistent URIs](https://joinup.ec.europa.eu/collection/semantic-interoperability-community-semic/document/10-rules-persistent-uris),
...
([Falcons](http://ws.nju.edu.cn/services/Falcon-AO),
[Watson](http://kmi.open.ac.uk/technologies/name/watson/),
[Swoogle](http://swoogle.umbc.edu/))
or directories ([LOV](https://lov.linkeddata.es/dataset/lov/), the European
Commission’s [Joinup platform](https://joinup.ec.europa.eu), or
domain specific portals as the
[Bioportal](http://bioportal.bioontology.org/) for the biological
...
[W3C list](https://www.w3.org/wiki/ConverterToRdf) for instance. The
...
[DCAT-AP for Switzerland](dcat-ap-ch.md)), and also the links to other datasets,
as for instance DBPedia (the Linked Data version of Wikipedia), to make
the new dataset part of the [Linked Data Cloud](https://lod-cloud.net/).
...
[W3C recommendation](https://www.w3.org/TR/sparql11-overview/).
...
[technical section](#Data-Access-Triple-store-and-SPARQL).
...
[publish a reference to it](/en/category/publish) on opendata.swiss.
...
> ![RDF layer cake](_static/images/linked-open-data/ld-stack.png)
...
[a W3C standard](https://www.w3.org/TR/rdf-primer/)), a framework to
...
> ![RDF triple](_static/images/linked-open-data/ld-triple.png)
...
> ![RDF Graph](_static/images/linked-open-data/ld-graph.png)
...
> ![structured data formats](_static/images/linked-open-data/ld-struct-data-formats.png)
...
> ![RDF graph with URIs](_static/images/linked-open-data/ld-graph-uri.png)
...
[RDFSchema (RDFs)](https://www.w3.org/TR/rdf-schema/) and the
...
- [http://dbpedia.org/page/Albert_Einstein](http://dbpedia.org/page/Albert_Einstein)
- [http://dbpedia.org/page/Eduard_Einstein](http://dbpedia.org/page/Eduard_Einstein)
...
[wiki.dbpedia.org](https://wiki.dbpedia.org/datasets)
...
accessed [here](https://dbpedia.org/sparql)
...
- [https://sws.ifi.uio.no/sparqler/validator.html](https://sws.ifi.uio.no/sparqler/validator.html)
