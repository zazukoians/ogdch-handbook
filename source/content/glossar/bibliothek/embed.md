...
The [ckan.js](https://github.com/okfn/ckan.js)
...
![Architecture diagram for embedding opendata.swiss on a website](_static/images/embed/embed-architecture.png)

We have developed a [JavaScript widget](https://github.com/opendata-swiss/ckan-embed)
based on `ckan.js` which displays the same information about datasets as the
standard search. It uses the [CKAN API](http://docs.ckan.org/en/latest/api/) to
run search queries, and renders the result into the Web page. Our solution is
similar to the
[CKAN Data Viewer](http://docs.ckan.org/en/latest/maintaining/data-viewer.html),
...
![Example for an emmbedding of opendata.swiss on opentransportdata.swiss](_static/images/embed/embed-widget.png)
...
Standards like the [Open Graph protocol](http://ogp.me)
and [oEmbed](http://oembed.com)
...
![Example from OpenGraph](_static/images/embed/embed-opengraph.png)
...
some examples: [pelican-open_graph](https://github.com/whiskyechobravo/pelican-open_graph)
[opengraph by erikriver](https://github.com/erikriver/opengraph),
[Drupal](https://www.drupal.org/project/oembed),
[JavaScript/Node.js](https://www.npmjs.com/package/open-graph),
and a middleware API at [Opengraph.io](https://www.opengraph.io/documentation/).
...
- It is difficult to navigate with the keyboard into an IFRAME and visitors
  ...
  [accessibility requirements](http://www.accessibility-checklist.ch/).
...
[JavaScript Widget](#embed-widget)
is not possible, we have shown a basic workaround above.

## Middleware

For the [JavaScript widget](#embed-widget) solution described above,
...
[ckanapi client](https://github.com/ckan/ckanapi) could be used
...
approach is described in the [govpack package](https://www.npmjs.com/package/govpack).
...
[ckanext-odn-ic2pc-sync](https://github.com/OpenDataNode/ckanext-odn-ic2pc-sync)
...
[Zhang Haojie et al., 2015](https://www.researchgate.net/publication/283356205_Data-as-a-Service_A_Cloud-Based_Federated_Platform_to_Facilitate_Discovery_of_Private_Sector_Datasets).
