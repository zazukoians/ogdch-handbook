...
auf der [Abnahmeumgebung](../../glossar/begriffe.md#term-Abnahmeumgebung)
...
- [Benutzer-Dashboard](#benutzer-dashboard)
- [Benutzerkontenverwaltung](#benutzerkonten-verwaltung)
- [Benutzer-Navigation](#benutzer-navigation)

<a id="passwort-setzen"></a>
...
Anschliessend können Sie sich dann im Backend der [Abnahmeumgebung](../../glossar/begriffe.md#term-Abnahmeumgebung)
von opendata.swiss einloggen.

![Passwort setzen](_static/images/publizieren/benutzer/passwort_setzen.png)

<a id="benutzer-dashboard"></a>
...
![Benutzer Dashboard im Backend von opendata.swiss](_static/images/publizieren/benutzer/benutzer-dashboard.png)

<a id="benutzerkonten-verwaltung"></a>

### Benutzerkontenverwaltung

Zu Ihrem Benutzerkonto gelangen Sie, wenn Sie im Dashboard auf «Bearbeitete Einstellungen» klicken.

![Webformular für das Benutzerprofil](_static/images/publizieren/benutzer/benutzer-profil.png)
...
im [Backend](../../glossar/begriffe.md#term-Backend) erscheinen.
...
<a id="benutzer-navigation"></a>

### Benutzer-Navigation

Als Benutzer steht Ihnen ganz oben rechts eine Navigationsleiste zur Verfügung:

![Benutzer Navigationsleiste im Backend von opendata.swiss](_static/images/publizieren/benutzer/benutzer-navigation.png)
...
- [`Screencast zum Login`](../../../_static/screencasts/login.gif) - In diesem Screencast zeigen wir Ihnen das Einloggen auf dem [Backend](../../glossar/begriffe.md#term-Backend)

[Nächster Schritt: Informationen zur publizierenden Organisation ergänzen](organisation-einrichten.md)
