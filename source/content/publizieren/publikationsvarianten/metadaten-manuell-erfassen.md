...
![Benutzerübersicht im Input-Bereich von I14Y. Zu sehen sind sechs Kacheln.](_static/images/publizieren/manuelle-datenerfassung/benutzer-uebersicht-kacheln.png)
...
![Arbeitsbereich I14Y-Metadatenkatalog.](_static/images/publizieren/manuelle-datenerfassung/benutzer-uebersicht-i14ymetadatenkatalog.png)
...
![Abbildung Dropdown mit Schaltfläche neue Datensammlung erfassen](_static/images/publizieren/manuelle-datenerfassung/dataset-erfassen.png)
...
![Webformular Datensatz erstellen mit den Details zum Datensatz](_static/images/publizieren/manuelle-datenerfassung/dataset-details.png)
...
![Ausschnitt aus Details Identifikator bis Änderungsdatum](_static/images/publizieren/manuelle-datenerfassung/dataset-details-identifikator.png)
...
![Felder zum Beschreiben der Kontaktstelle](_static/images/publizieren/manuelle-datenerfassung/dataset-kontaktstellen.png)
...
![Felder zum Ankreuzen der Sprache](_static/images/publizieren/manuelle-datenerfassung/dataset-sprachen.png)
...
![Auswahl des Themenbereichs von I14Y und Schaltfläche speichern und schliessen](_static/images/publizieren/manuelle-datenerfassung/dataset-katalog-themen-speichern.png)
...
![Auswahl des Opendata-Katalogs über die Schaltfläche Katalog verknüpfen](_static/images/publizieren/manuelle-datenerfassung/dataset-katalog-verknuepfen.png)
...
![Neues Auswahlfeld für die Themen des Opendata-Katalogs](_static/images/publizieren/manuelle-datenerfassung/dataset-verknuepfter-katalog.png)
...
![Ansicht der Themen des I14Y-Katalogs und des Opendata-Katalogs](_static/images/publizieren/manuelle-datenerfassung/dataset-themen-opendataswiss.png)
...
![Ansicht der Felder im Bereich Schutzbedarf](_static/images/publizieren/manuelle-datenerfassung/dataset-schutzbedarf.png)
...
![Eingabefeld von Schlüsselwörtern](_static/images/publizieren/manuelle-datenerfassung/dataset-schluesselwoerter.png)
<br/>
...
![Eingabefeld von «Landing Page»](_static/images/publizieren/manuelle-datenerfassung/dataset-landingpage.png)
...
![Eingabefelder räumliche Abdeckung und GeoIV-ID](_static/images/publizieren/manuelle-datenerfassung/dataset-raumliche-abdeckung.png)
...
![Eingabefelder zeitliche Abdeckung und Frequenz](_static/images/publizieren/manuelle-datenerfassung/dataset-zeitliche-abdeckung.png)
...
![Eingabefeld Konform zu](_static/images/publizieren/manuelle-datenerfassung/dataset-konformzu.png)
...
![Eingabefeld Dokumente](_static/images/publizieren/manuelle-datenerfassung/dataset-dokumente.png)
...
![Eingabefeld wird referenziert von](_static/images/publizieren/manuelle-datenerfassung/dataset-referenziertvon.png)
...
![Eingabefeld Qualifizierte Rollenzuordnung](_static/images/publizieren/manuelle-datenerfassung/dataset-rollenzuordnung.png)
...
![Eingabefeld qualifizierte Beziehung](_static/images/publizieren/manuelle-datenerfassung/dataset-qualifizierte-beziehung.png)
...
![Permalink des Datensatzes im Feld Identifier im Bereich zusätzliche Informationen auf opendata.swiss](_static/images/publizieren/manuelle-datenerfassung/dataset-zusatzliche-info.png)
...
![Eingabefeld verwandte Ressourcen mit Link auf Fedlex-Artikel](_static/images/publizieren/manuelle-datenerfassung/dataset-relation.png)
...
![Eingabefeld Bild](_static/images/publizieren/manuelle-datenerfassung/dataset-bild.png)
...
![Eingabefelder für die Version](_static/images/publizieren/manuelle-datenerfassung/dataset-version.png)
<br/>
...
![Reiter Distribution](_static/images/publizieren/manuelle-datenerfassung/dataset-distribution.png)
...
![Eingabefelder für die Beschreibung der Distribution im Bereich Details](_static/images/publizieren/manuelle-datenerfassung/distribution-details.png)
...
![Eingabefelder im ereich Zugangs-URL](_static/images/publizieren/manuelle-datenerfassung/distribution-zugangs-url.png)
...
![Eingabefelder im ereich Zugangs-URL](_static/images/publizieren/manuelle-datenerfassung/distribution-lizenz.png)
...
![Eingabefelder im Bereich Abdeckung](_static/images/publizieren/manuelle-datenerfassung/distribution-abdeckung.png)
...
![Eingabefeld Konform zu](_static/images/publizieren/manuelle-datenerfassung/distribution-konformzu.png)
...
![Eingabefeld Dokumente](_static/images/publizieren/manuelle-datenerfassung/distribution-dokumente.png)
...
![Reiter Distribution mit einer Übersicht der erstellten Distributionen](_static/images/publizieren/manuelle-datenerfassung/distribution-uebersicht.png)
...
![Ansicht der beschriebenen Felder des Datensatzes](_static/images/publizieren/manuelle-datenerfassung/dataset-beschreibung-pruefen.png)
<br/>
...
![Ansicht Auswahl Status Kandidat](_static/images/publizieren/manuelle-datenerfassung/status-kandidat.png)
...
![Ansicht Auswahl Status I14Y](_static/images/publizieren/manuelle-datenerfassung/status-i14y.png)
<br/>
![Ansicht Auswahl Status I14Y](_static/images/publizieren/manuelle-datenerfassung/status-uebersicht.png)
...
![Ansicht Status Publikation Aktuell I14Y](_static/images/publizieren/manuelle-datenerfassung/status-publiziert.png)
...
![Ansicht eines Datensatzes auf opendata.swiss](_static/images/publizieren/manuelle-datenerfassung/dataset-frontend.png)
